...
RSpec.describe Api::V1::MembershipsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "renders a JSON response with the new membership" do

        post :create, params: {membership: valid_attributes}, session: valid_session
        expect(response).to have_http_status(:created)
        expect(response.content_type).to eq('application/json')
        expect(response.location).to eq(membership_url(Membership.last))
      end
    end

    context "with invalid params" do
      it "renders a JSON response with errors for the new membership" do
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "renders a JSON response with the membership" do
        membership = Membership.create! valid_attributes
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the membership" do
        membership = Membership.create! valid_attributes
