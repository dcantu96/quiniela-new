...
export default function (ctx, inject) {
  ...
  // Register strategies
  // local
  $auth.registerStrategy('local', new scheme_003d9a64($auth, {"endpoints":{"login":{"url":"/oauth/token","method":"post","propertyName":"access_token"},"logout":{"url":"/oauth/revoke","method":"post"},"user":{"url":"/me","method":"get","propertyName":false}},"_name":"local"}))
